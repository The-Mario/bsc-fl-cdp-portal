...
function DRRInfo({ isMobile, savings }) {
  ...
  return (
    <CdpViewCard title={lang.reward.title} style={{padding: '0px 20px'}}>
      ...
      <InfoContainerRow
        title={
          <TextBlock style={{ fontSize: '14px', color: getColor('whiteText') }}>
            {lang.reward.rewards_earned_to_date}
          </TextBlock>
        }
        value={
          <>
