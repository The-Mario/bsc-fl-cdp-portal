export default {
  ...
  overview_page: {
    ...
    reward_per_hour_hirisk: 'Reward per hour for FL/stable pools',
    reward_per_hour_lowrisk: 'Reward per hour for USDFL/stable pools',
    reward_epoch: 'epoch',
    reward_epoch_hirisk: 'reward epoch for USDFL/FL pool',
    reward_epoch_lowrisk: 'reward epoch for stable pool',
    reward_global_info: 'Global info',
    reward_your_info: 'Your reward',
    reward_select: 'Select your earned pool to get reward',
    reward_all: 'ALL REWARDS',
    reward_earned_hirisk: 'FL/STABLE POOLS',
    reward_earned_lowrisk: 'USDFL/STABLE POOLS',
  ...
  reward_page: {
    ...
    address: 'address',
    on_wallet: 'ON WALLET',
    on_wallet_value: 'On wallet (USD)',
    locked: 'Locked',
    locked_value: 'Locked (USD)',
    allowance: 'Allowance',
  ...
  sidebar: {
    ...
    reward_button: 'GET ALL REWARDS',
    reward_button_hi_risk: 'GET FL/STABLE',
    reward_button_low_risk: 'GET USDFL/STABLE',
  ...
  transactions: {
    ...
    get_reward_all: 'Getting all reward {0} FL',
    get_reward_h: 'Getting FL/STABLE reward {0} FL',
    get_reward_l: 'Getting USDFL/STABLE reward {0} FL',
